...
class Paint extends JFrame {
	...
	public Paint(String title, MenuCircular menu) {
		super(title);
		this.menu = menu;
	...
	public static void main(String argv[]) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				LinkedList<MenuElement> listMenuTool = new LinkedList();
				listMenuTool.add(new MenuElement("rect"));
				listMenuTool.add(new MenuElement("pen"));
				listMenuTool.add(new MenuElement("oval"));
				MenuCircular menuTool = new MenuCircular(null, listMenuTool, "tool");

				Paint paint = new Paint("paint", menuTool);
